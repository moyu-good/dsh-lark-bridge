...
// 2) 组合树含新插件
const tree = execSync('node /mnt/d/PROJECT/deepseek-harness/apps/cli/lib/bin.js --profile chat --dump-config 2>/dev/null || true',
...
// 3) 飞书面板命令清单
const env = readFileSync('/root/.dsh/env-scathach.env', 'utf8')
