 ...
 */
export function isAgentStatusEvent(event) {
    return event.type === 'agent/status';
}
export function isSubagentStartEvent(event) {
    return event.type === 'subagent/start';
}
export function isSubagentEndEvent(event) {
    return event.type === 'subagent/end';
}
export function isSkillsChangeEvent(event) {
    return event.type === 'skills/change';
}
export function isWorkflowLogEvent(event) {
    return event.type === 'workflow/log';
}
export function isWorkflowPhaseEvent(event) {
