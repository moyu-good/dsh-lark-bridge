 ...
 */
export declare function isTodoWriteEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: TodoWriteData;
};
/**
 ...
 */
export declare function isGoalChangeEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: GoalChangeData;
};
/** Narrow a session event to one workflow run opening. */
export declare function isWorkflowRunStartEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: WorkflowRunStartData;
};
/** Narrow a session event to one workflow member publication. */
export declare function isWorkflowAgentStartEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: WorkflowAgentStartData;
};
/** Narrow a session event to one workflow member settlement. */
export declare function isWorkflowAgentEndEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: WorkflowAgentEndData;
};
/** Narrow a session event to one workflow run closing. */
export declare function isWorkflowRunEndEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: WorkflowRunEndData;
};
/** Narrow a session event to a compaction lock opening. */
export declare function isCompactionStartEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: CompactionStartData;
};
/** Narrow a session event to a compaction lock releasing. */
export declare function isCompactionEndEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: CompactionEndData;
};
/** Narrow a session event to a compaction summary (what replaced old history). */
export declare function isCompactionSummaryEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: CompactionSummaryData;
};
/** Narrow a session event to a model-free prune of old history. */
export declare function isCompactionPruneEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: CompactionPruneData;
};
...
export declare function isWebSearchRequestEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: WebSearchRequestData;
};
/** Narrow a session event to one scheduled model-call retry. */
export declare function isLlmRetryEvent(event: HostSessionEvent): event is HostSessionEvent & {
    readonly data: LlmRetryData;
};
/**
 ...
 */
export declare function toolResultText(data: ToolResultData): {
