...
export function subagentLine(descriptor) {
...
export function scheduleLine(notice) {
 ...
 */
export function retryLine(retry) {
    if (retry.maxRetries === undefined || retry.retry !== retry.maxRetries)
        return undefined;
