 ...
 */
export function permissionPosture(env = process.env) {
 ...
 */
export function commandGuide(posture) {
    const lines = [
        '常用命令：',
 ...
 */
export function onboardingText(posture, identity) {
...
export function onboardingMessage(env = process.env, identity) {
    return { markdown: onboardingText(permissionPosture(env), identity) };
}
//# sourceMappingURL=first-contact.js.map