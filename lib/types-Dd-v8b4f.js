...
*/
async function runCommandLine(line, agent, commands, signal, presets = void 0, persistence = void 0, chatId = void 0, deniedTools = void 0, schedules = void 0, audits = void 0, config = void 0, sessionPresets = void 0, sessionQuery = void 0, jobs = void 0, feedback = void 0, lastAssistantMessageId = void 0, tokenMeter = void 0, skills = void 0, defaultModel = void 0, configModel = void 0, workspaces = void 0, currentCwd = void 0, loaderEntries = void 0) {
...
*/
async function collectImages(msg, port, attachments, enabled, reason = "attachImages 未开启") {
...
*/
const ACQUIRE_TIMEOUT_MS = 45e3;
const TURN_START_TIMEOUT_MS = 45e3;
...
function installBridge(ctx, config, port, notify, authorization) {
	...
	*/
	...
	const turnWatchdog = /* @__PURE__ */ new Map();
	...
	const armTurnWatchdog = (sessionId, chatId) => {
		...
		const timer = setTimeout(() => {
			...
			port.send(chatId, { text: "⚠️ 模型会话没有产生回应（上一任务未正常结束），正在自动重启服务，本条消息稍后会自动重试…" }).catch(reportSendFailure);
	...
	*/
	...
	const handleMessage = async (msg) => {
		...
		try {
			...
			const opened = await Promise.race([acquireFor, new Promise((_, reject) => {
				const timer = setTimeout(() => reject(/* @__PURE__ */ new Error(ACQUIRE_HUNG_MARKER)), ACQUIRE_TIMEOUT_MS);
			...
			if (imagesEnabled && visionPrefixes !== void 0 && visionPrefixes.length > 0) {
			...
			if (String(error).includes(ACQUIRE_HUNG_MARKER)) {
				...
				await port.send(msg.chatId, { text: "⚠️ 会话调度挂起（上一轮未正常结束），正在自动重启服务，本条消息稍后会自动重试…" }).catch(reportSendFailure);
				if (config.restartCommand !== "") scheduleRestart(config.restartCommand);
				return;
			}
