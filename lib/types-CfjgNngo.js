...
*/
async function runCommandLine(line, agent, commands, signal, presets = void 0, persistence = void 0, chatId = void 0, deniedTools = void 0, schedules = void 0, audits = void 0, config = void 0, sessionPresets = void 0) {
	...
	if (name === "sessions") return runSessionsCommand(agent, persistence, chatId);
...
function installBridge(ctx, config, port, notify, authorization) {
	...
	*/
	...
	ctx.on("session/event", (session, event) => {
		...
		if (isWorkflowRunStartEvent(event)) replay.send(binding.chatId, { markdown: runStartLine(event.data) }).catch(reportSendFailure);
		...
		else if (isWorkflowRunEndEvent(event)) replay.send(binding.chatId, { markdown: runEndLine(event.data) }).catch(reportSendFailure);
