...
*/
const USER_GUIDE = `**MyBot（MyBot）使用说明**

**一、这是什么**
我是跑在 DeepSeek Harness 上的编码智能体，通过MyBot接进飞书。同一个飞书应用背后是 web + desktop 双端舰队——**同一时刻只有活跃端回复**（防双回复），另一端待命。
